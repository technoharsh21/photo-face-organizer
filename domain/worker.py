...
class ScanWorker(QThread):
    """
    Background worker thread executing the photo scanner pipeline.
    ...
    def run(self):
        ...
        for i in range(self.start_index, self.total_files):
            ...
            # Performance throttle if Eco mode
    ...
    def _process_file(self, file_path: Path, index: int):
        ...
        try:
            ...
            if not face_locations:
                # No faces detected in photo -> No Match
            ...
            # 3. Evaluate photo matches across individual & compulsory group profiles
            ...
            # Update unknown faces for unmatched detected faces
